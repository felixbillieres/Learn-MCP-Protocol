"""
Test script for Python Exercise 21
...
def test_concept():
    ...
    spec = importlib.util.spec_from_file_location("exercise", "exercise_21.py")
...
if __name__ == "__main__":
    print("Testing Python Exercise 21 - Advanced MCP Concepts\n")
    ...
    if passed == len(tests):
        print("🎉 All tests passed! You're ready for MCP Project 21!")
    else:
