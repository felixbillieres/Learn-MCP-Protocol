"""
Test script for Python Exercise 20
...
def test_concept():
    ...
    spec = importlib.util.spec_from_file_location("exercise", "exercise_20.py")
...
if __name__ == "__main__":
    print("Testing Python Exercise 20 - Advanced MCP Concepts\n")
    ...
    if passed == len(tests):
        print("🎉 All tests passed! You're ready for MCP Project 20!")
    else:
